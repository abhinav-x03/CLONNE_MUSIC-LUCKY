...
# ----------------------------------------------------------------
# ----------------------------------------------------------------
SOURCE = getenv("SOURCE", "https://t.me/CLONNE_MUSIC_BOT?startgroup=true")
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ZXCVBNMASDFGHJKLQWERTYUIOP0786/CLONNE_MUSIC",
)
...
CHAT = getenv("CHAT", "https://t.me/ZiddiXBot")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
...
CLONNE_PICS = [
"https://files.catbox.moe/8tkumi.jpg",
"https://files.catbox.moe/8tkumi.jpg",

]

START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/8tkumi.jpg"
)
